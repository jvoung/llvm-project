...
makeRegisterPragmasAction(NullabilityPragmas &Pragmas) {
  return [&Pragmas]() {
...
std::vector<ComparableNullabilityLoc>
getComparableNullabilityLocs(llvm::StringRef Snippet,
                             llvm::StringRef HeaderWithAttributes = "") {
...
protected:
  ...
  Matcher<std::vector<ComparableNullabilityLoc>>
  matchesRanges(MissingLocSlots SlotsWithNoLocs = {}) {
    if (Snippet.empty()) {
