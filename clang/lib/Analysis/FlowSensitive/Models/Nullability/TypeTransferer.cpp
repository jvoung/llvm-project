...
#include "clang/Analysis/FlowSensitive/Models/Nullability/TypeTransferer.h"
...
static void computeNullability(const Expr *E,
...
static const TypeNullability &
getNullabilityForChild(const Expr *E,
                       TransferState<PointerNullabilityLattice> &State) {
...
static const Decl *
getAssociatedTemplateDecl(const SubstTemplateTypeParmType *ST) {
  const Decl *AssociatedDecl = ST->getAssociatedDecl();
  if (!AssociatedDecl)
    return nullptr;
  if (isa<RedeclarableTemplateDecl>(AssociatedDecl))
...
struct Resugarer {
  ...
  struct FromEnclosingClassNullability {
    ...
    std::optional<TypeNullability> operator()(const SubstTy *ST) const {
      if (Specialization != ST->getAssociatedDecl())
        return std::nullopt;
  ...
  struct FromTemplateArgs {
    ...
    operator()(const SubstTy *ST,
               const TypeNullabilityDefaults &Defaults) const {
      if (Template != getAssociatedTemplateDecl(ST))
        return std::nullopt;
...
static void
transferDeclRefExpr(const DeclRefExpr *DRE, const MatchFinder::MatchResult &MR,
                    TransferState<PointerNullabilityLattice> &State) {
...
static void
transferMemberExpr(const MemberExpr *ME, const MatchFinder::MatchResult &MR,
                   TransferState<PointerNullabilityLattice> &State) {
...
static void transferCastExpr(const CastExpr *CE,
...
static void
transferCXXBindTemporaryExpr(const CXXBindTemporaryExpr *BTE,
                             const MatchFinder::MatchResult &MR,
                             TransferState<PointerNullabilityLattice> &State) {
...
static void
transferCopyOrMoveConstruct(const CXXConstructExpr *CCE,
                            const MatchFinder::MatchResult &MR,
                            TransferState<PointerNullabilityLattice> &State) {
...
static TypeNullability computeTypeNullabilityForCallExpr(
    const CallExpr *CE, TransferState<PointerNullabilityLattice> &State) {
...
static void
transferCXXOperatorCallExpr(const CXXOperatorCallExpr *CE,
                            const MatchFinder::MatchResult &MR,
                            TransferState<PointerNullabilityLattice> &State) {
  computeNullability(CE, State, [&]() {
...
static void
transferUnaryOperator(const UnaryOperator *UO,
                      const MatchFinder::MatchResult &MR,
                      TransferState<PointerNullabilityLattice> &State) {
...
static void
transferBinaryOperator(const BinaryOperator *BO,
                       const MatchFinder::MatchResult &MR,
                       TransferState<PointerNullabilityLattice> &State) {
...
static void transferNewExpr(const CXXNewExpr *NE,
                            const MatchFinder::MatchResult &MR,
                            TransferState<PointerNullabilityLattice> &State) {
...
static void
transferArraySubscriptExpr(const ArraySubscriptExpr *ASE,
                           const MatchFinder::MatchResult &MR,
                           TransferState<PointerNullabilityLattice> &State) {
...
static void transferThisExpr(const CXXThisExpr *TE,
                             const MatchFinder::MatchResult &MR,
                             TransferState<PointerNullabilityLattice> &State) {
