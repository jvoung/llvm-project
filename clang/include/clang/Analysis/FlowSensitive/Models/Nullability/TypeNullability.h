...
#ifndef LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_TYPENULLABILITY_H
#define LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_TYPENULLABILITY_H
...
struct TypeNullabilityDefaults {
  // TODO: remove this legacy constructor that ignores pragmas
  ...
  // TODO: this should always be provided, clean up callers.
  ...
  // TODO: this should always be provided, clean up callers.
  const NullabilityPragmas *FileNullability;
};
...
/// TODO: clean up all callers and remove this.
