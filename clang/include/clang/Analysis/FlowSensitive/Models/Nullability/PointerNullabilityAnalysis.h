...
#ifndef LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYANALYSIS_H
#define LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYANALYSIS_H
...
public:
  ...
  dataflow::ComparisonResult
  compare(QualType Type, const dataflow::Value &Val1,
          const dataflow::Environment &Env1, const dataflow::Value &Val2,
          const dataflow::Environment &Env2) override;

  std::optional<dataflow::WidenResult>
  widen(QualType Type, dataflow::Value &Prev,
...
private:
  ...
  dataflow::StorageLocation &
  getTopStorageLocation(dataflow::DataflowAnalysisContext &DACtx, QualType Ty);
...
#endif // LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYANALYSIS_H
