...
#ifndef LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYMATCHERS_H
#define LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYMATCHERS_H
...
isSmartPointerMethodCallFunc(llvm::ArrayRef<const llvm::StringRef *> NameRefs);
...
ast_matchers::internal::Matcher<Stmt>
isSmartPointerOperatorCall(llvm::StringRef Name, int NumArgs);
...
#endif // LLVM_CLANG_ANALYSIS_FLOWSENSITIVE_MODELS_NULLABILITY_POINTERNULLABILITYMATCHERS_H
